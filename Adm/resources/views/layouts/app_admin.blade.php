    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-newspaper-o"></i> <span>Новости</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.admin.news.index')}}">Список новостей</a></li>
                        <li><a href="{{route('blog.admin.news.create')}}">Добавить новость</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#"><i class="fa fa-wrench"></i> <span>Сервисы</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.admin.services.index')}}">Список сервисов</a></li>
                        <li><a href="{{route('blog.admin.services.create')}}">Добавить сервиса</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#"><i class="fa fa-file-text"></i> <span>Статические страницы</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.admin.staticpages.index')}}">Список страниц</a></li>
                        <li><a href="{{route('blog.admin.staticpages.create')}}">Добавить страницу</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#"><i class="fa fa-male"></i> <span>Комманда</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.admin.teams.index')}}">Список сотрудников</a></li>
                        <li><a href="{{route('blog.admin.teams.create')}}">Добавить сотрудника</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#"><i class="fa fa-black-tie"></i> <span>Вакансии</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.admin.vacancies.index')}}">Список вакансий</a></li>
                        <li><a href="{{route('blog.admin.vacancies.create')}}">Добавить вакансию</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#"><i class="fa fa-photo"></i> <span>Галлерея</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.admin.topgalleries.index')}}">Список галереи</a></li>
                        <li><a href="{{route('blog.admin.topgalleries.create')}}">Добавить галерею</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#"><i class="fa fa-handshake-o"></i> <span>Партнёры</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.admin.partners.index')}}">Список партнёров</a></li>
                        <li><a href="{{route('blog.admin.partners.create')}}">Добавить партнёра</a></li>
                    </ul>
                </li>
                <li class="treeview">
...
@include('blog.admin.news.include.script_img')
@include('blog.admin.news.include.script_gallery')
@include('blog.admin.service.include.script_img')
@include('blog.admin.service.include.script_gallery')
@include('blog.admin.staticpage.include.script_img')
@include('blog.admin.staticpage.include.script_gallery')
@include('blog.admin.team.include.script_img')
@include('blog.admin.topgallery.include.script_img')
@include('blog.admin.vacancy.include.script_img')
@include('blog.admin.partner.include.script_img')
