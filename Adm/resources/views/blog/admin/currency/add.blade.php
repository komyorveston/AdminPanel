					...
					<form action="{{url('/admin/currency/add')}}" method="post" data-toggle="validator">
						...
						<div class="box-body">
							...
							<div class="form-group has-feedback">
								...
								<input type="text" name="value" class="form-control" id="title" placeholder="Значение" title="если это базовая валюта поставьте 1, то курс к базовой валюте." required data-error="Допускаются цифры и десятичная точка" pattern="^[0-9.]{1,}">
								<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group has-feedback">
								<label for="value">
								<input type="checkbox" name="base">Базовая валюта
								</label>
							</div>
						</div>
