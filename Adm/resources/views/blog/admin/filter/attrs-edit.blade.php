...
@section('content')
	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<!--id="addattrs"  для my.s //Чтобы нужно было обязательно выбрать-->
					<form action="{{url('/admin/filter/attrs-edit', $attr->id)}}" method="post" data-toggle="validator" id="addattrs">
						@csrf
						<div class="box-body">
